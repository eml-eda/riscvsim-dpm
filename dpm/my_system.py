...
class Soc(gvsoc.systree.Component):
    def __init__(self, parent, name, parser):
        ...
        # power intercorrect
        pm.o_POWER_CTRL(host.i_POWER())
        pm.o_VOLTAGE_CTRL(host.i_VOLTAGE())

        pm.o_POWER_CTRL_1(sensor1.i_POWER())
        pm.o_POWER_CTRL_2(sensor2.i_POWER())
        pm.o_POWER_CTRL_3(sensor3.i_POWER())

        pm.o_VOLTAGE_CTRL_1(sensor1.i_VOLTAGE())
        pm.o_VOLTAGE_CTRL_2(sensor2.i_VOLTAGE())
        pm.o_VOLTAGE_CTRL_3(sensor3.i_VOLTAGE())
